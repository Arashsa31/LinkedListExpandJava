...
/**
 * Item.java: Item class represents grocery items to be added to the shopping
 * list
 */
...
public class Item implements Comparable<Item> {
	...
	public void setName(String name) {
		// The length of product name is limited to [1,50], if more than 50 characters,
		// use the first 50 chars
